...
import InvestorBiddingPanel from "@/components/investor/InvestorBiddingPanel";
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-6 py-16 lg:px-12">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-4">
        {[["Plan", investor.subscription_plan || "—"], ["Status", investor.subscription_status || "—"], ["Active bids", bids.filter((b) => b.status === "active").length], ["Properties won", investor.properties_won || 0]].map(([l, v]) => (
      ...
      <div className="mt-12">
        <InvestorBiddingPanel investor={investor} />
      </div>
