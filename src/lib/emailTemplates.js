/**
 * Hidden Property Intel — Email Template Gallery (frontend copy)
 * Mirrors base44/shared/emailTemplates.ts for browser-safe imports.
 */
...
const WRAPPER = (content) => `<div style="font-family:Inter,Arial,sans-serif;max-width:600px;margin:auto;color:#1a1a1a;line-height:1.65">
