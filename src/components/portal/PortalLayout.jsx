...
export default function PortalLayout() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden pb-[74px] lg:pb-0" style={{ background: "#f7f5f0" }}>
      <LuxNav />
      <div className="flex min-h-[calc(100vh-5rem)] md:min-h-[calc(100vh-7rem)] pt-20 md:pt-28">
