        ...
        <div className="grid gap-12 lg:grid-cols-[1.5fr_1fr_1fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-6 border-t border-white/10 pt-5 text-sm leading-relaxed text-white/60">
              ...
              <a href="tel:+19548848885" className="mt-1 inline-block text-white/70 transition-colors hover:text-gold-warm">954-884-8885</a>
              <p className="mt-2 text-[10px] uppercase tracking-[0.2em] text-white/40">Strategic Minds AI LLC</p>
