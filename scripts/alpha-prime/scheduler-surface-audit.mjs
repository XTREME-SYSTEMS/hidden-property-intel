...
// The runtime validator uses SCHEDULER_INVENTORY, so make under-counting impossible:
// every recurring authority record discovered from source must have a matching static
// inventory row. Multiplicity matters, e.g. two Vercel crons in one vercel.json require
// two rows for that authority.
